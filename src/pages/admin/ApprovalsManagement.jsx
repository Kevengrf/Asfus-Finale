      ...
      {loading ? (
        ...
        <ul className={styles.approvalList}>
          {preCadastros.map(cadastro => (
            <li key={cadastro.id} className={styles.approvalItem}>
              ...
              <div className={styles.itemActions}>
                <button onClick={() => handleApproval(cadastro.id, true)} className={styles.approveButton}>Aprovar</button>
                <button onClick={() => handleApproval(cadastro.id, false)} className={styles.rejectButton}>Reprovar</button>
              </div>
            </li>
          ))}
        </ul>
